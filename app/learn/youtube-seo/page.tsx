...
const ARTICLE = LEARN_ARTICLES["youtube-seo"];
    ...
    <main className={s.page}>
      ...
      <header className={s.hero}>
        ...
        <p className={s.subtitle}>
          Learn how to optimize your YouTube videos for search and
          recommendations. This guide covers titles, thumbnails, descriptions,
          and the engagement signals that actually matter.
        </p>
        <ArticleMeta
      ...
      <article className={s.content}>
        ...
        <div className={s.highlight}>
          <p>
            <strong>See what is working.</strong> {BRAND.name} helps you analyze
            your video performance, spot patterns in successful content, and
            find opportunities to improve. Get data driven SEO insights.
          </p>
        </div>
        ...
        {/* CTA */}
        <LearnStaticCTA
          title="Improve Your Video Performance"
          description={`${BRAND.name} shows you what is working in your niche and helps you make better content decisions.`}
        />
      </article>
    </main>
  );
