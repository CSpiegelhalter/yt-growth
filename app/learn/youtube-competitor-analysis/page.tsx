    ...
    <main className={s.page}>
      ...
      <header className={s.hero}>
        <nav className={s.breadcrumb}>
          <Link href="/">Home</Link> / <Link href="/learn/youtube-channel-audit">Learn</Link> / Competitor Analysis
        </nav>
      ...
      <div className={s.content}>
        ...
        <section className={s.section}>
          ...
          <ul className={s.list}>
            <li><strong>Outlier videos:</strong> Videos that perform 2-3x above the channel&apos;s average indicate resonant topics</li>
            <li><strong>Title patterns:</strong> What structures do they use? Numbers? Questions? How-tos?</li>
            <li><strong>Thumbnail styles:</strong> Colors, faces, text usage—what gets clicks in your niche?</li>
            <li><strong>Video length:</strong> What duration performs best for your topic type?</li>
            <li><strong>Posting frequency:</strong> How often do successful channels upload?</li>
            <li><strong>Hook strategies:</strong> Watch the first 30 seconds of top videos—how do they open?</li>
          </ul>
        </section>
        ...
        <section className={s.section}>
          ...
          <ol className={s.numberedList}>
            <li><strong>Calculate the channel&apos;s average views</strong> over the last 20-30 videos to establish a baseline</li>
            <li><strong>Identify videos with 2x+ the average</strong>—these are your outliers worth studying</li>
            <li><strong>Look for patterns</strong> across multiple outliers: common topics, formats, or title structures</li>
            <li><strong>Check recency</strong>—recent outliers are more relevant than year-old hits</li>
            <li><strong>Analyze velocity</strong>—how fast did the video gain views? This indicates algorithm favor</li>
          </ol>
        </section>
        ...
        <section className={s.section}>
          ...
          <ul className={s.list}>
            <li><strong>Copying titles directly:</strong> Learn the pattern, then create your own original version</li>
            <li><strong>Only looking at top creators:</strong> Mega-channels play by different rules. Study channels similar to your size</li>
            <li><strong>Ignoring context:</strong> A video might have gone viral for reasons unrelated to its content quality</li>
            <li><strong>Focusing on views only:</strong> High views with low engagement might indicate clickbait that doesn&apos;t convert</li>
            <li><strong>Analysis paralysis:</strong> Don&apos;t spend so much time researching that you never create</li>
          </ul>
        </section>
        ...
        <div className={s.highlight}>
          <p>
            <strong>{BRAND.name} automates competitor tracking</strong> by monitoring channels similar to yours and surfacing their top-performing videos. Get alerts for outliers, trending topics, and emerging opportunities in your niche.
          </p>
        </div>
        ...
        <section className={s.faqSection}>
          ...
          <div className={s.faqList}>
            <div className={s.faqItem}>
              <h3 className={s.faqQuestion}>How do I find competitor channels to analyze?</h3>
            ...
            <div className={s.faqItem}>
              <h3 className={s.faqQuestion}>What are outlier videos and why do they matter?</h3>
              <p className={s.faqAnswer}>
                Outlier videos are videos that perform significantly better than a channel&apos;s average (usually 2x+). They indicate topics or formats that resonate strongly with audiences. Studying outliers helps you identify proven opportunities.
              </p>
            </div>
            <div className={s.faqItem}>
              <h3 className={s.faqQuestion}>How many competitors should I track?</h3>
              <p className={s.faqAnswer}>
