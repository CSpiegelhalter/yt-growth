...
const ARTICLE = LEARN_ARTICLES["free-youtube-subscribers"];
    ...
    <main className={s.page}>
      ...
      <header className={s.hero}>
        ...
        <h1 className={s.title}>
          Free YouTube Subscribers and Views: Why These Services Hurt Your
          Channel
        </h1>
        <p className={s.subtitle}>
          Tempted by services offering free subscribers or views? Before you
          use them, understand how they damage your channel and what to do
          instead.
        </p>
        <ArticleMeta
      ...
      <article className={s.content}>
        ...
        {/* CTA */}
        <LearnStaticCTA
          title="Grow Your Channel the Right Way"
          description={`${BRAND.name} shows you what content drives real subscribers and views. Build a channel that lasts.`}
        />
      </article>
    </main>
  );
