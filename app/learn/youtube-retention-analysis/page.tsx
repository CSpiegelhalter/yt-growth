      ...
      <div className={s.content}>
        ...
        <section className={s.section}>
          ...
          <p className={s.sectionText}>
            ...
            valuable, leading to more impressions and suggested video
            placements.
          </p>
        ...
        <section className={s.section}>
          ...
          <ul className={s.list}>
            <li>
              <strong>Steep initial drop (0-30 sec):</strong> Your hook isn't
              compelling enough or doesn't match your title/thumbnail
            </li>
            <li>
              <strong>Gradual decline:</strong> Normal behavior—content is
              engaging but some viewers naturally leave
            </li>
            <li>
              <strong>Sharp mid-video drops:</strong> Specific section is
              boring, confusing, or off-topic
            </li>
            <li>
              <strong>Spikes above 100%:</strong> Viewers are rewatching
              specific sections—this content resonates
            </li>
            <li>
              <strong>Cliff at the end:</strong> Normal—viewers leave before end
              screens
            </li>
          </ul>
        </section>
        ...
        <section className={s.section}>
          ...
          <ol className={s.numberedList}>
            <li>
              <strong>The Early Exit (0-30 seconds):</strong> Viewers click away
              immediately. Fix: Start with a stronger hook—state the value
              proposition in the first 5 seconds.
            </li>
            <li>
              <strong>The Intro Death (30-60 seconds):</strong> Long intros kill
              retention. Fix: Cut unnecessary intro footage. Get to the main
              content faster.
            </li>
            <li>
              <strong>The Mid-Video Cliff:</strong> Sharp drop at a specific
              point. Fix: Review that section. Is it slow? Off-topic? Cut or
              restructure it.
            </li>
            <li>
              <strong>The Slow Bleed:</strong> Gradual decline throughout. Fix:
              Add pattern interrupts—change camera angles, insert B-roll, or use
              on-screen graphics.
            </li>
            <li>
        ...
        <section className={s.section}>
          ...
          <ul className={s.list}>
            <li>
              <strong>Open with a hook:</strong> State what viewers will
              learn/see in the first 5 seconds
            </li>
            <li>
              <strong>Use pattern interrupts:</strong> Change something every
              30-60 seconds (camera angle, graphics, music)
            </li>
            <li>
              <strong>Create open loops:</strong> Tease upcoming content to keep
              viewers watching for payoff
            </li>
            <li>
              <strong>Deliver on your promise fast:</strong> Don't make viewers
              wait for what they clicked for
            </li>
            <li>
              <strong>Cut ruthlessly:</strong> If a section doesn't add value,
              remove it
            </li>
            <li>
              <strong>Use chapters:</strong> Help viewers find what they want
              (and stay longer overall)
            </li>
          </ul>
        </section>
        ...
        <div className={s.highlight}>
          <p>
            ...
            provides AI-powered hypotheses for why viewers leave. Get specific,
            actionable fixes for each video instead of guessing what went wrong.
          </p>
        </div>
