    ...
    <main className={s.page}>
      ...
      <section className={s.socialProof}>
        <p className={s.proofText}>
          Trusted by <strong>2,000+</strong> YouTube creators to grow their channels
        </p>
      </section>
      ...
      <section className={s.pillars} id="features">
        ...
        <div className={s.pillar}>
          ...
          <ul className={s.pillarBenefits}>
            <li>Identify underperforming videos and why they&apos;re not getting views</li>
            <li>Get a content quality score with specific improvement areas</li>
            <li>See how your channel compares to similar creators in your niche</li>
          </ul>
        ...
        <div className={s.pillar}>
          ...
          <p className={s.pillarDesc}>{FEATURES.retentionAnalysis.description}</p>
          <ul className={s.pillarBenefits}>
          ...
          <Link href="/learn/youtube-retention-analysis" className={s.pillarLink}>
        ...
        <div className={s.pillar}>
          ...
          <p className={s.pillarDesc}>{FEATURES.subscriberDrivers.description}</p>
          <ul className={s.pillarBenefits}>
            <li>Find your best-converting videos that turn viewers into subscribers</li>
            <li>Understand the patterns that drive subscriber growth</li>
            <li>Double down on content that builds your audience</li>
          </ul>
          <Link href="/learn/how-to-get-more-subscribers" className={s.pillarLink}>
        ...
        <div className={s.pillar}>
          ...
          <p className={s.pillarDesc}>{FEATURES.competitorAnalysis.description}</p>
          <ul className={s.pillarBenefits}>
          ...
          <Link href="/learn/youtube-competitor-analysis" className={s.pillarLink}>
