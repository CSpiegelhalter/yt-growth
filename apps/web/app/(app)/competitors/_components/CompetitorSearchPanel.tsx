...
type Props = {
  ...
  /**
   * @deprecated No longer used. Remove in next cleanup.
   */
  mode?: "search" | "discover";
};

/**
 * CompetitorSearchPanel - Search inputs for competitor search
 *
 * Provides:
 * - Niche text input + Reference video URL
