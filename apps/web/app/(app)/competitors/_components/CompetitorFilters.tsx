...
export default function CompetitorFilters({
  ...
  function handleContentTypeChange(e: ChangeEvent<HTMLSelectElement>) {
    onChange({ ...filters, contentType: e.target.value as ContentType });
  }

  function handleDateRangeChange(e: ChangeEvent<HTMLSelectElement>) {
    onChange({ ...filters, dateRange: e.target.value as DateRange });
  }

  function handleMinViewsChange(e: ChangeEvent<HTMLSelectElement>) {
