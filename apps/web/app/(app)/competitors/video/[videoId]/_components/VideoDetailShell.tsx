...
type VideoInfo = CompetitorVideoAnalysis["video"];

function VideoHeader({ video, ageDays }: { video: VideoInfo; ageDays: number }) {
  return (
    <header className={s.videoHeader}>
      ...
      <div className={s.videoInfo}>
        ...
        <div className={s.channelMeta}>
          ...
          <span className={s.publishDate}>{formatDate(video.publishedAt)}</span>
        </div>
...
export default function VideoDetailShell({
  ...
  return (
    <main className={s.page}>
      ...
      <VideoHeader video={video} ageDays={ageDays} />
