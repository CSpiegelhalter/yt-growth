...
/**
 * ProfileClient - Interactive client component for account management
 */
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="View your account details and manage your subscription"
      />

      {err && <ErrorAlert message={err} />}

      <div className={styles.twoColumn}>
        {/* Left card — account overview + channels */}
        ...
        {/* Right column — BillingCTA / UpgradeCard */}
...
function ChannelListSection({
  ...
  return (
    <div>
      ...
      <a href="/videos" className={styles.addChannelBtn}>
        Add Channel
      </a>
    </div>
  );
