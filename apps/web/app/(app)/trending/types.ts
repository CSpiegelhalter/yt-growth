...
/** Discovery list types - the 4 canonical views */
export type DiscoveryListType = 
  | "fastest_growing"   // Top individual videos by velocity
  | "breakouts"         // Small channels outperforming their size
...
export const LIST_TYPE_OPTIONS: Record<DiscoveryListType, { label: string; desc: string; icon: string }> = {
  fastest_growing: { 
    label: "Fastest Growing", 
    desc: "Videos gaining views fastest right now",
    icon: "trending",
  },
  breakouts: { 
    label: "Breakouts", 
    desc: "Small channels punching above their weight",
    icon: "rocket",
  },
  emerging_niches: { 
    label: "Emerging Niches", 
    desc: "Semantic clusters of trending topics",
    icon: "sparkles",
  },
  low_competition: { 
    label: "Low Competition", 
    desc: "High demand niches with small creators winning",
    icon: "target",
  },
};

export const DEFAULT_LIST_TYPE: DiscoveryListType = "emerging_niches";
