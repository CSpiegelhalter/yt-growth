...
export const LEARN_ARTICLES = {
  "youtube-channel-audit": {
    ...
    title:
      "YouTube Analytics That Actually Grow Your Channel: A Practical Channel Audit Guide",
    shortTitle: "Channel Audit",
    navLabel: "Channel Audit",
    description:
      "Learn a practical, no-drama way to audit your YouTube videos using the metrics that matter most—CTR, audience retention, and post-watch behavior—plus the context that helps you decide what to fix next.",
    metaDescription:
    ...
    toc: [
      { id: "one-metric-mistake", title: "The One-Metric Mistake" },
      { id: "growth-loop", title: "The Core YouTube Growth Loop" },
      { id: "diagnose-ctr", title: "Diagnose CTR the Right Way" },
      { id: "diagnose-retention", title: "Diagnose Retention" },
      { id: "diagnose-post-watch", title: "Diagnose Post-Watch Behavior" },
      { id: "supporting-context", title: "Supporting Context" },
      { id: "emotional-trap", title: "The 48-Hour Emotional Trap" },
      { id: "pattern-detection", title: "Spot Patterns Across Uploads" },
      { id: "audit-output", title: "What a Quality Audit Looks Like" },
      { id: "faq", title: "FAQ" },
    ],
    faqs: [
      {
  ...
  "how-to-get-more-subscribers": {
    ...
    toc: [
      {
        id: "subscribers-byproduct",
        title: "What Subscribers Actually Reflect",
      },
      ...
      {
        id: "channel-page",
        title: "Turn Your Channel Page Into a Conversion Page",
      },
      {
        id: "subscriber-rate",
        title: "Subscriber Rate (Definition + Formula)",
      },
      {
        id: "publish-clean",
        title: "Publish Without Sabotaging Early Signals",
      },
