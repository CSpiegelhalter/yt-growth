...
function MegaphoneVsLighthouse() {
  return (
    ...
    >
      ...
      <rect x="10" y="15" width="230" height="250" rx="12" fill="var(--color-imperial-blue)" />
      
      {/* Swirling black hole - more detailed */}
      <ellipse cx="175" cy="130" rx="65" ry="55" fill="var(--color-imperial-blue)" />
      <ellipse cx="175" cy="130" rx="50" ry="40" fill="var(--color-imperial-blue)" />
      ...
      <g transform="translate(25, 95)">
        ...
        <circle cx="35" cy="35" r="28" fill="#f5d0a9" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        {/* Hair */}
        <path d="M10 25 Q20 5, 45 8 Q65 10, 60 28" fill="var(--color-imperial-blue)" />
        ...
        <path d="M18 32 L28 36" stroke="var(--color-imperial-blue)" strokeWidth="2.5" />
        <path d="M52 32 L42 36" stroke="var(--color-imperial-blue)" strokeWidth="2.5" />
        {/* Wide desperate eyes with bloodshot */}
        <ellipse cx="26" cy="42" rx="6" ry="5" fill="white" />
        <ellipse cx="44" cy="42" rx="6" ry="5" fill="white" />
        <circle cx="26" cy="43" r="3" fill="var(--color-imperial-blue)" />
        <circle cx="44" cy="43" r="3" fill="var(--color-imperial-blue)" />
        {/* Tiny red veins in eyes */}
        <path d="M20 40 L23 42" stroke="var(--color-hot-rose)" strokeWidth="0.5" />
        <path d="M50 40 L47 42" stroke="var(--color-hot-rose)" strokeWidth="0.5" />
        {/* Bags under eyes */}
        ...
        <ellipse cx="35" cy="56" rx="8" ry="6" fill="var(--color-imperial-blue)" />
        ...
        {/* Tongue */}
        <ellipse cx="35" cy="59" rx="4" ry="2" fill="var(--color-hot-rose)" />
        
        {/* REALISTIC MEGAPHONE - chrome/metal */}
        <g transform="translate(60, 20)">
          {/* Cone - gradient effect with multiple layers */}
          <path d="M0 25 L55 5 L55 50 Z" fill="var(--color-hot-rose)" />
          <path d="M5 25 L55 8 L55 47 Z" fill="var(--color-hot-rose)" />
      ...
      <g transform="translate(340, 50)">
        ...
        <path d="M0 80 Q0 0, 60 0 Q120 0, 120 80 L100 80 Q100 20, 60 20 Q20 20, 20 80 Z" fill="var(--color-hot-rose)" />
        {/* Silver tips */}
        ...
        {/* N and S poles */}
        <text x="10" y="105" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--color-imperial-blue)">N</text>
        <text x="110" y="105" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--color-imperial-blue)">S</text>
      </g>
      
      {/* YouTube Play Button being attracted */}
      <g transform="translate(320, 165)">
        <rect x="-12" y="-8" width="24" height="16" rx="3" fill="var(--color-hot-rose)" />
        <path d="M-4 -4 L6 0 L-4 4 Z" fill="white" />
        {/* Motion lines */}
        <line x1="-28" y1="0" x2="-18" y2="0" stroke="var(--color-hot-rose)" strokeWidth="2" />
        <line x1="-25" y1="-5" x2="-17" y2="-3" stroke="var(--color-hot-rose)" strokeWidth="1.5" />
      </g>
      
      {/* Thumbs up (like) being attracted */}
      <g transform="translate(485, 160)">
        <circle cx="0" cy="0" r="14" fill="var(--color-cool-sky)" />
        ...
        {/* Motion lines */}
        <line x1="20" y1="0" x2="28" y2="0" stroke="var(--color-cool-sky)" strokeWidth="2" />
      </g>
      
      {/* Subscriber bell being attracted */}
      <g transform="translate(350, 200)">
        <circle cx="0" cy="0" r="12" fill="#fbbf24" />
        <path d="M0 -6 Q-5 -3, -5 2 L5 2 Q5 -3, 0 -6" fill="var(--color-imperial-blue)" />
        <circle cx="0" cy="4" r="2" fill="var(--color-imperial-blue)" />
        {/* Motion lines */}
      ...
      <g transform="translate(420, 200)">
        <rect x="-18" y="-10" width="36" height="20" rx="4" fill="var(--color-stormy-teal)" />
        <text x="0" y="4" textAnchor="middle" fontSize="10" fill="white" fontWeight="700">+1K</text>
        {/* Motion lines pointing up toward magnet */}
        <line x1="0" y1="-18" x2="0" y2="-28" stroke="var(--color-stormy-teal)" strokeWidth="2" />
      </g>
      
      {/* Comment bubble being attracted */}
      <g transform="translate(480, 195)">
        <ellipse cx="0" cy="0" rx="14" ry="12" fill="var(--color-hot-rose)" />
        <path d="M-6 10 L0 18 L6 10" fill="var(--color-hot-rose)" />
        {/* Three dots like typing indicator */}
        <circle cx="-5" cy="0" r="2" fill="white" />
        <circle cx="0" cy="0" r="2" fill="white" />
        <circle cx="5" cy="0" r="2" fill="white" />
        {/* Motion lines */}
        <line x1="18" y1="-5" x2="25" y2="-8" stroke="var(--color-hot-rose)" strokeWidth="2" />
      </g>
      ...
      <text x="450" y="48" textAnchor="middle" fontSize="11" fill="var(--color-stormy-teal-hover)" fontWeight="600">Come to me,</text>
      <text x="450" y="62" textAnchor="middle" fontSize="10" fill="var(--color-stormy-teal-hover)">my people!</text>
      
      <text x="405" y="255" textAnchor="middle" fontSize="12" fill="var(--color-stormy-teal-hover)" fontStyle="italic">*satisfied magnet noises*</text>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g transform="translate(340, 70)">
        {/* Tree shadow */}
        <ellipse cx="15" cy="85" rx="12" ry="4" fill="var(--color-imperial-blue)" opacity="0.15" />
        {/* Trunk */}
        <rect x="10" y="65" width="10" height="20" fill="var(--color-imperial-blue)" />
        <rect x="11" y="67" width="3" height="18" fill="var(--color-imperial-blue)" />
        {/* Branches - layered */}
        <polygon points="15,0 -5,35 35,35" fill="var(--color-stormy-teal-hover)" />
      ...
      <g transform="translate(55, 55)" filter="url(#snowShadow)">
        ...
        {/* Tiny play button */}
        <path d="M-4 -2 L5 0 L-4 2 Z" fill="var(--color-hot-rose)" />
      </g>
      ...
      <g transform="translate(165, 105)" filter="url(#snowShadow)">
        ...
        {/* Play button */}
        <path d="M-8 -3 L10 0 L-8 3 Z" fill="var(--color-hot-rose)" />
        {/* Viewer icons embedded */}
        <circle cx="-25" cy="-5" r="6" fill="var(--color-cool-sky)" stroke="white" strokeWidth="2" />
        <circle cx="22" cy="15" r="5" fill="var(--color-stormy-teal)" stroke="white" strokeWidth="2" />
      </g>
      ...
      <g transform="translate(315, 155)" filter="url(#snowShadow)">
        ...
        {/* Play button */}
        <path d="M-15 -5 L20 0 L-15 5 Z" fill="var(--color-hot-rose)" />
        {/* Many viewer icons embedded in snow */}
        <circle cx="-45" cy="-10" r="8" fill="var(--color-cool-sky)" stroke="white" strokeWidth="2" />
        <circle cx="-35" cy="-40" r="6" fill="var(--color-stormy-teal)" stroke="white" strokeWidth="2" />
        <circle cx="40" cy="-20" r="7" fill="var(--color-hot-rose)" stroke="white" strokeWidth="2" />
        <circle cx="48" cy="10" r="6" fill="var(--color-hot-rose)" stroke="white" strokeWidth="2" />
        <circle cx="35" cy="40" r="6" fill="var(--color-cool-sky)" stroke="white" strokeWidth="2" />
        <circle cx="-40" cy="35" r="6" fill="var(--color-cool-sky)" stroke="white" strokeWidth="2" />
        <circle cx="-15" cy="45" r="5" fill="var(--color-stormy-teal)" stroke="white" strokeWidth="2" />
      ...
      {/* MOMENTUM label */}
      <text x="315" y="70" textAnchor="middle" fontSize="18" fontWeight="700" fill="var(--color-hot-rose-hover)">MOMENTUM!</text>
  ...
  return (
    ...
    >
      ...
      <g transform="translate(280, 15)">
        <rect x="0" y="0" width="105" height="80" fill="#fffbeb" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        <rect x="5" y="5" width="95" height="70" fill="white" stroke="#d4a574" strokeWidth="1" />
        <text x="52" y="20" textAnchor="middle" fontSize="6" fill="var(--color-imperial-blue)" fontStyle="italic">This certifies that</text>
        <text x="52" y="34" textAnchor="middle" fontSize="10" fontWeight="700" fill="var(--color-imperial-blue)">Dr. Algorithm</text>
        <text x="52" y="47" textAnchor="middle" fontSize="5" fill="#64748b">has completed training in</text>
        <text x="52" y="58" textAnchor="middle" fontSize="6" fontWeight="600" fill="var(--color-imperial-blue)">Video Quality</text>
        <text x="52" y="67" textAnchor="middle" fontSize="6" fontWeight="600" fill="var(--color-imperial-blue)">Assessment</text>
        {/* Seal - moved to bottom right corner */}
        <circle cx="85" cy="62" r="7" fill="var(--color-hot-rose)" opacity="0.8" />
      </g>
      
      {/* Eye chart on wall - YouTube themed */}
      <g transform="translate(20, 10)">
        <rect x="0" y="0" width="70" height="95" fill="white" stroke="#94a3b8" strokeWidth="2" />
        <text x="35" y="20" textAnchor="middle" fontSize="18" fontWeight="700" fill="var(--color-imperial-blue)">C</text>
        <text x="35" y="38" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--color-imperial-blue)">T R</text>
        <text x="35" y="52" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-imperial-blue)">A V D</text>
        <text x="35" y="65" textAnchor="middle" fontSize="8" fontWeight="700" fill="var(--color-imperial-blue)">W A T C H</text>
        <text x="35" y="76" textAnchor="middle" fontSize="6" fontWeight="700" fill="var(--color-imperial-blue)">R E T E N T I O N</text>
        <text x="35" y="88" textAnchor="middle" fontSize="4" fontWeight="700" fill="var(--color-imperial-blue)">T H U M B N A I L</text>
      </g>
      ...
      {/* Medical supplies */}
      <rect x="130" y="30" width="8" height="20" rx="2" fill="var(--color-hot-rose)" />
      <rect x="142" y="35" width="6" height="15" rx="2" fill="var(--color-cool-sky)" />
      <rect x="152" y="32" width="8" height="18" rx="2" fill="var(--color-stormy-teal)" />
      ...
      <g transform="translate(115, 95)">
        ...
        <rect x="0" y="0" width="75" height="55" rx="6" fill="var(--color-hot-rose)" stroke="var(--color-hot-rose-hover)" strokeWidth="3" />
        {/* Screen glare */}
        ...
        <circle cx="20" cy="12" r="12" fill="white" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        <circle cx="55" cy="12" r="12" fill="white" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        {/* Pupils looking at doctor nervously - dilated */}
        <circle cx="24" cy="14" r="5" fill="var(--color-imperial-blue)" />
        <circle cx="59" cy="14" r="5" fill="var(--color-imperial-blue)" />
        ...
        <line x1="0" y1="35" x2="-15" y2="45" stroke="var(--color-hot-rose-hover)" strokeWidth="4" />
        <line x1="75" y1="35" x2="90" y2="45" stroke="var(--color-hot-rose-hover)" strokeWidth="4" />
        <circle cx="-17" cy="47" r="5" fill="var(--color-hot-rose-hover)" />
        <circle cx="92" cy="47" r="5" fill="var(--color-hot-rose-hover)" />
        
        {/* Little stick legs dangling */}
        <line x1="20" y1="55" x2="15" y2="75" stroke="var(--color-hot-rose-hover)" strokeWidth="4" />
        <line x1="55" y1="55" x2="60" y2="75" stroke="var(--color-hot-rose-hover)" strokeWidth="4" />
        {/* Feet */}
        <ellipse cx="12" cy="78" rx="7" ry="4" fill="var(--color-hot-rose-hover)" />
        <ellipse cx="63" cy="78" rx="7" ry="4" fill="var(--color-hot-rose-hover)" />
      </g>
      ...
      <g transform="translate(260, 105)">
        ...
        {/* Headband */}
        <rect x="20" y="8" width="50" height="6" rx="2" fill="var(--color-imperial-blue)" />
        ...
        <circle cx="36" cy="39" r="3" fill="var(--color-imperial-blue)" />
        <circle cx="56" cy="39" r="3" fill="var(--color-imperial-blue)" />
        ...
        {/* Pens in pocket */}
        <rect x="58" y="98" width="2" height="10" fill="var(--color-cool-sky)" />
        <rect x="62" y="99" width="2" height="9" fill="var(--color-hot-rose)" />
        {/* Name tag */}
        <rect x="15" y="95" width="30" height="12" rx="2" fill="white" stroke="#94a3b8" strokeWidth="1" />
        <text x="30" y="103" textAnchor="middle" fontSize="5" fill="var(--color-imperial-blue)">Dr. Algorithm</text>
        
        {/* Stethoscope - detailed */}
        <path d="M45 72 Q20 85, 25 130" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
        <path d="M45 72 Q70 85, 65 130" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
        {/* Earpieces */}
        <circle cx="25" cy="72" r="4" fill="#475569" />
        <circle cx="65" cy="72" r="4" fill="#475569" />
        {/* Chest piece */}
        <circle cx="25" cy="135" r="12" fill="#475569" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        <circle cx="25" cy="135" r="6" fill="var(--color-imperial-blue)" />
        ...
        {/* Clipboard - detailed */}
        <rect x="95" y="115" width="40" height="55" rx="3" fill="var(--color-imperial-blue)" />
        ...
        {/* Checkmarks */}
        <path d="M103 128 L106 132 L112 124" stroke="var(--color-stormy-teal)" strokeWidth="2" fill="none" />
        <path d="M103 138 L106 142 L112 134" stroke="var(--color-stormy-teal)" strokeWidth="2" fill="none" />
  ...
  return (
    ...
    >
      ...
      <g transform="translate(30, 30)">
        ...
        {/* Hair - messy, stressed */}
        <path d="M20 45 Q30 15, 75 10 Q120 15, 130 45 Q125 25, 100 20 Q75 15, 50 20 Q25 25, 20 45" fill="var(--color-imperial-blue)" />
        <path d="M25 42 Q35 30, 55 28" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        <path d="M125 42 Q115 30, 95 28" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        {/* Some stray hairs from stress */}
        <path d="M45 15 Q42 5, 48 8" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        <path d="M105 15 Q108 5, 102 8" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        ...
        <path d="M38 58 Q50 50, 62 58" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
        <path d="M88 58 Q100 50, 112 58" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
        ...
        <path d="M35 70 Q50 62, 65 70" stroke="var(--color-imperial-blue)" strokeWidth="2.5" fill="none" />
        <path d="M35 74 Q50 82, 65 74" stroke="var(--color-imperial-blue)" strokeWidth="2.5" fill="none" />
        {/* Sliver of visible eye */}
        <ellipse cx="50" cy="72" rx="12" ry="3" fill="white" />
        <ellipse cx="52" cy="72" rx="4" ry="2" fill="var(--color-imperial-blue)" />
        <circle cx="53" cy="71.5" r="1" fill="var(--color-imperial-blue)" />
        ...
        <path d="M85 70 Q100 62, 115 70" stroke="var(--color-imperial-blue)" strokeWidth="2.5" fill="none" />
        <path d="M85 74 Q100 82, 115 74" stroke="var(--color-imperial-blue)" strokeWidth="2.5" fill="none" />
        {/* Sliver of visible eye */}
        <ellipse cx="100" cy="72" rx="12" ry="3" fill="white" />
        <ellipse cx="98" cy="72" rx="4" ry="2" fill="var(--color-imperial-blue)" />
        <circle cx="97" cy="71.5" r="1" fill="var(--color-imperial-blue)" />
        {/* Heavy wrinkles around eye */}
      ...
      <text x="5" y="35" fontSize="28" fill="var(--color-cool-sky)" fontWeight="700">?</text>
      <text x="140" y="25" fontSize="20" fill="var(--color-cool-sky)">?</text>
      <text x="25" y="185" fontSize="16" fill="var(--color-cool-sky)">?</text>
      ...
      <g transform="translate(250, 35)">
        ...
        <rect x="0" y="0" width="70" height="130" rx="10" fill="var(--color-imperial-blue)" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        {/* Screen bezel */}
        <rect x="4" y="10" width="62" height="110" rx="4" fill="#f8fafc" />
        {/* Camera notch */}
        <ellipse cx="35" cy="5" rx="8" ry="3" fill="var(--color-imperial-blue)" />
        {/* Home indicator */}
        <rect x="22" y="123" width="26" height="3" rx="1.5" fill="var(--color-imperial-blue)" />
        
        {/* YouTube app mockup */}
        <rect x="6" y="14" width="58" height="12" fill="var(--color-hot-rose)" />
        ...
        <rect x="30" y="33" width="18" height="6" fill="var(--color-hot-rose)" />
        <rect x="18" y="46" width="20" height="6" fill="#a78bfa" />
        <rect x="42" y="44" width="14" height="8" fill="var(--color-hot-rose)" />
      ...
      <g transform="translate(340, 25)">
        ...
        <text x="60" y="25" textAnchor="middle" fontSize="16" fill="var(--color-imperial-blue)" fontWeight="700">WHAT</text>
        <text x="60" y="48" textAnchor="middle" fontSize="16" fill="var(--color-imperial-blue)" fontWeight="700">IS THAT?!</text>
      ...
      <text x="240" y="220" textAnchor="middle" fontSize="15" fill="var(--color-imperial-blue)" fontWeight="600">If YOU can't read it, neither can viewers.</text>
    </svg>
  );
}
...
function MissionControl() {
  return (
    ...
    >
      ...
      <rect x="0" y="0" width="380" height="200" rx="8" fill="var(--color-imperial-blue)" />
      ...
      <rect x="100" y="15" width="180" height="75" rx="4" fill="var(--color-imperial-blue)" stroke="#475569" strokeWidth="2" />
      {/* YouTube video playing on main screen */}
      <rect x="110" y="22" width="100" height="58" rx="2" fill="var(--color-imperial-blue)" />
      {/* Video thumbnail */}
      <rect x="115" y="27" width="90" height="48" rx="1" fill="var(--color-hot-rose)" />
      <path d="M150 41 L170 51 L150 61 Z" fill="white" fillOpacity="0.9" />
      {/* Live indicator on screen */}
      <circle cx="128" cy="35" r="4" fill="var(--color-hot-rose)">
        <animate attributeName="opacity" values="1;0.3;1" dur="1s" repeatCount="indefinite" />
      </circle>
      <text x="140" y="38" fontSize="6" fontWeight="700" fill="var(--color-hot-rose)">LIVE</text>
      
      {/* Stats display on main screen right side */}
      <rect x="218" y="25" width="55" height="50" fill="var(--color-imperial-blue)" />
      <text x="245" y="40" textAnchor="middle" fontSize="6" fill="#94a3b8">REAL-TIME</text>
      <text x="245" y="56" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--color-stormy-teal)">847</text>
      <text x="245" y="68" textAnchor="middle" fontSize="5" fill="#64748b">watching now</text>

      {/* Row of smaller status screens */}
      <rect x="20" y="20" width="70" height="50" rx="3" fill="var(--color-imperial-blue)" stroke="#334155" strokeWidth="1" />
      <text x="55" y="33" textAnchor="middle" fontSize="6" fill="var(--color-cool-sky)">CTR MONITOR</text>
      <text x="55" y="52" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--color-stormy-teal)">4.2%</text>
      
      <rect x="290" y="20" width="70" height="45" rx="3" fill="var(--color-imperial-blue)" stroke="#334155" strokeWidth="1" />
      <text x="325" y="35" textAnchor="middle" fontSize="6" fill="var(--color-cool-sky)">AVG VIEW</text>
      <text x="325" y="52" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--color-stormy-teal)">3:42</text>
      ...
      {/* Left panel - comments */}
      <rect x="50" y="148" width="80" height="35" rx="3" fill="var(--color-imperial-blue)" stroke="#64748b" strokeWidth="1" />
      <text x="90" y="160" textAnchor="middle" fontSize="6" fill="var(--color-cool-sky)">COMMENTS</text>
      <text x="90" y="175" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--color-stormy-teal)">23</text>
      {/* Blinking new comment indicator */}
      <circle cx="125" cy="155" r="3" fill="var(--color-cool-sky)">
        <animate attributeName="opacity" values="1;0;1" dur="0.5s" repeatCount="indefinite" />
      </circle>
      
      {/* Center panel - main controls */}
      <rect x="145" y="148" width="90" height="35" rx="3" fill="var(--color-imperial-blue)" stroke="var(--color-hot-rose)" strokeWidth="2" />
      {/* Button row */}
      <circle cx="165" cy="162" r="6" fill="var(--color-stormy-teal)" />
      <circle cx="185" cy="162" r="6" fill="#fbbf24" />
      <circle cx="205" cy="162" r="6" fill="var(--color-cool-sky)" />
      <circle cx="225" cy="162" r="6" fill="var(--color-hot-rose)" />
      {/* Slider */}
      <rect x="155" y="173" width="60" height="4" rx="2" fill="#475569" />
      <rect x="155" y="173" width="35" height="4" rx="2" fill="var(--color-hot-rose)" />
      
      {/* Right panel - subs */}
      <rect x="250" y="148" width="80" height="35" rx="3" fill="var(--color-imperial-blue)" stroke="#64748b" strokeWidth="1" />
      <text x="290" y="160" textAnchor="middle" fontSize="6" fill="var(--color-hot-rose)">NEW SUBS</text>
      <text x="290" y="175" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--color-stormy-teal)">+12</text>

      {/* Creator in command chair */}
      <g transform="translate(170, 95)">
        {/* Chair back */}
        <rect x="-10" y="15" width="60" height="40" rx="5" fill="var(--color-imperial-blue)" />
        {/* Head */}
        <circle cx="20" cy="12" r="18" fill="var(--color-cool-sky-light)" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        {/* Headset */}
        <path d="M2 8 Q20 -5, 38 8" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
        <rect x="-2" y="5" width="8" height="12" rx="2" fill="var(--color-imperial-blue)" />
        <rect x="34" y="5" width="8" height="12" rx="2" fill="var(--color-imperial-blue)" />
        {/* Mic */}
        <path d="M6 15 Q15 22, 14 25" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        <circle cx="14" cy="27" r="3" fill="var(--color-imperial-blue)" />
        {/* Focused eyes (looking at screens) */}
        <circle cx="13" cy="10" r="4" fill="white" />
        <circle cx="27" cy="10" r="4" fill="white" />
        <circle cx="15" cy="11" r="2" fill="var(--color-imperial-blue)" />
        <circle cx="29" cy="11" r="2" fill="var(--color-imperial-blue)" />
        {/* Determined mouth */}
        <path d="M12 20 Q20 17, 28 20" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        {/* Body */}
        <rect x="5" y="30" width="30" height="25" rx="3" fill="var(--color-hot-rose)" />
      </g>

      {/* Coffee mug */}
      <rect x="340" y="155" width="18" height="22" rx="3" fill="var(--color-imperial-blue)" />
      <path d="M358 162 Q365 165, 358 175" stroke="var(--color-imperial-blue)" strokeWidth="3" fill="none" />
      {/* Steam */}
      ...
      <rect x="20" y="188" width="340" height="8" rx="2" fill="var(--color-imperial-blue)" />
      <rect x="22" y="190" width="180" height="4" rx="1" fill="var(--color-stormy-teal)" />
...
function CommentTennisMatch() {
  return (
    ...
    >
      ...
      {/* Stadium lights */}
      <circle cx="50" cy="20" r="8" fill="var(--color-cool-sky-light)" />
      <circle cx="250" cy="20" r="8" fill="var(--color-cool-sky-light)" />
      ...
      <rect x="148" y="65" width="4" height="100" fill="var(--color-imperial-blue)" />
      {/* Net mesh */}
      ...
      <g transform="translate(55, 95)">
        {/* Body lunging to hit */}
        <ellipse cx="0" cy="25" rx="12" ry="8" fill="var(--color-hot-rose)" /> {/* torso */}
        {/* Head */}
        <circle cx="0" cy="8" r="12" fill="var(--color-cool-sky-light)" stroke="var(--color-imperial-blue)" strokeWidth="1.5" />
        {/* Tennis headband */}
        <rect x="-12" y="2" width="24" height="5" rx="2" fill="var(--color-hot-rose)" />
        {/* Focused eyes */}
        <circle cx="-4" cy="8" r="2" fill="var(--color-imperial-blue)" />
        <circle cx="4" cy="8" r="2" fill="var(--color-imperial-blue)" />
        {/* Determined mouth */}
        <path d="M-4 14 Q0 12, 4 14" stroke="var(--color-imperial-blue)" strokeWidth="1.5" fill="none" />
        {/* Arm swinging racket */}
        <line x1="10" y1="20" x2="35" y2="5" stroke="var(--color-cool-sky-light)" strokeWidth="4" />
        {/* Tennis racket - proper shape */}
        <ellipse cx="45" cy="-5" rx="15" ry="20" fill="none" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        ...
        {/* Racket handle */}
        <line x1="35" y1="5" x2="45" y2="15" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        {/* Legs in running pose */}
        <line x1="-5" y1="32" x2="-15" y2="55" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        <line x1="5" y1="32" x2="20" y2="50" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        {/* Tennis shoes */}
        <ellipse cx="-17" cy="57" rx="6" ry="3" fill="white" stroke="var(--color-imperial-blue)" strokeWidth="1" />
        <ellipse cx="22" cy="52" rx="6" ry="3" fill="white" stroke="var(--color-imperial-blue)" strokeWidth="1" />
      </g>
      
      {/* Viewer (right) - ready to return */}
      <g transform="translate(230, 105)">
        {/* Body in ready stance */}
        <ellipse cx="0" cy="20" rx="10" ry="7" fill="var(--color-cool-sky)" />
        {/* Head */}
        <circle cx="0" cy="5" r="11" fill="#c2410c" stroke="var(--color-imperial-blue)" strokeWidth="1.5" />
        {/* Tennis visor */}
        ...
        {/* Racket */}
        <ellipse cx="-35" cy="0" rx="12" ry="16" fill="none" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        <line x1="-25" y1="8" x2="-35" y2="16" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        {/* Legs ready */}
        <line x1="-4" y1="26" x2="-10" y2="45" stroke="var(--color-imperial-blue)" strokeWidth="2.5" />
        <line x1="4" y1="26" x2="10" y2="45" stroke="var(--color-imperial-blue)" strokeWidth="2.5" />
        {/* Shoes */}
      ...
      <text x="150" y="82" textAnchor="middle" fontSize="5" fontWeight="700" fill="var(--color-stormy-teal-hover)">Nice!</text>
      ...
      {/* Labels */}
      <text x="55" y="55" textAnchor="middle" fontSize="10" fontWeight="700" fill="var(--color-hot-rose-hover)">You</text>
      ...
      <text x="150" y="52" textAnchor="middle" fontSize="8" fontWeight="700" fill="var(--color-imperial-blue)">Rally: 5</text>
...
function DistributionVendingMachine() {
  return (
    ...
    >
      ...
      {/* THE VENDING MACHINE */}
      <rect x="120" y="15" width="180" height="175" rx="8" fill="var(--color-imperial-blue)" stroke="var(--color-imperial-blue)" strokeWidth="3" />
      
      {/* Glass front panel */}
      <rect x="130" y="25" width="130" height="120" rx="4" fill="var(--color-imperial-blue)" stroke="#334155" strokeWidth="2" />
      
      {/* "DISTRIBUTION" header with lights */}
      <rect x="135" y="30" width="120" height="18" rx="2" fill="var(--color-hot-rose)" />
      ...
      <rect x="135" y="52" width="120" height="28" fill="var(--color-imperial-blue)" />
      <g transform="translate(140, 55)">
        {/* YouTube item - big and prominent */}
        <rect x="0" y="0" width="35" height="22" rx="3" fill="var(--color-hot-rose)" />
        <path d="M12 8 L25 11 L12 14 Z" fill="white" />
        <text x="17" y="20" textAnchor="middle" fontSize="4" fill="white">A1</text>
      </g>
      {/* "BEST SELLER" tag */}
      <rect x="180" y="58" width="40" height="12" rx="2" fill="var(--color-stormy-teal)" />
      <text x="200" y="67" textAnchor="middle" fontSize="5" fontWeight="700" fill="white">BEST!</text>
      {/* Price tag */}
      <text x="230" y="72" textAnchor="middle" fontSize="7" fill="var(--color-stormy-teal)">FREE</text>

      {/* Shelf 2: Social platforms */}
      <rect x="135" y="82" width="120" height="28" fill="var(--color-imperial-blue)" />
      <g transform="translate(140, 85)">
        {/* X/Twitter */}
        <rect x="0" y="0" width="28" height="22" rx="3" fill="var(--color-imperial-blue)" stroke="#64748b" strokeWidth="1" />
      ...
      <g transform="translate(175, 85)">
        ...
        <defs>
          <linearGradient id="igGradient" x1="0%" y1="100%" x2="100%" y2="0%">
            ...
            <stop offset="100%" stopColor="var(--color-hot-rose)" />
          </linearGradient>
        </defs>
      ...
      <rect x="135" y="112" width="120" height="28" fill="var(--color-imperial-blue)" />
      <g transform="translate(140, 115)">
        {/* Reddit */}
        <rect x="0" y="0" width="28" height="22" rx="3" fill="var(--color-cool-sky)" />
        <circle cx="14" cy="9" r="5" fill="white" />
        <circle cx="11" cy="8" r="1" fill="var(--color-cool-sky)" />
        <circle cx="17" cy="8" r="1" fill="var(--color-cool-sky)" />
        <ellipse cx="14" cy="12" rx="3" ry="1.5" fill="var(--color-cool-sky)" />
      ...
      <g transform="translate(210, 115)">
        {/* Collab */}
        <rect x="0" y="0" width="28" height="22" rx="3" fill="var(--color-hot-rose)" />
      ...
      {/* Keypad */}
      <rect x="268" y="30" width="24" height="50" rx="2" fill="var(--color-imperial-blue)" />
      {/* Buttons */}
      ...
      {/* Display screen */}
      <rect x="268" y="85" width="24" height="15" rx="2" fill="var(--color-imperial-blue)" />
      <text x="280" y="95" textAnchor="middle" fontSize="6" fill="var(--color-stormy-teal)">A1</text>
      
      {/* Coin slot */}
      <rect x="272" y="105" width="16" height="3" rx="1" fill="var(--color-imperial-blue)" />
      ...
      <rect x="140" y="148" width="110" height="25" rx="4" fill="var(--color-imperial-blue)" />
      ...
      <g transform="translate(50, 80)">
        {/* Video body */}
        <rect x="0" y="0" width="45" height="32" rx="4" fill="var(--color-hot-rose)" stroke="var(--color-hot-rose-hover)" strokeWidth="2" />
        <path d="M13 10 L32 16 L13 22 Z" fill="white" />
        
        {/* Thinking face */}
        <circle cx="10" cy="5" r="4" fill="white" />
        <circle cx="35" cy="5" r="4" fill="white" />
        <circle cx="11" cy="6" r="2" fill="var(--color-imperial-blue)" />
        <circle cx="36" cy="6" r="2" fill="var(--color-imperial-blue)" />
        {/* Hmm expression */}
        <path d="M15 26 Q22 24, 30 26" stroke="#c7d2fe" strokeWidth="2" fill="none" />
        
        {/* Hand pointing/reaching */}
        <line x1="45" y1="18" x2="65" y2="15" stroke="var(--color-hot-rose-hover)" strokeWidth="3" />
        <circle cx="67" cy="14" r="4" fill="var(--color-hot-rose-hover)" />
        ...
        <text x="-5" y="-52" textAnchor="middle" fontSize="7" fill="var(--color-imperial-blue)">Start with</text>
        <text x="-5" y="-40" textAnchor="middle" fontSize="8" fill="var(--color-hot-rose)" fontWeight="700">A1!</text>
      </g>
...
function HonestFarmerVsSketchyRat() {
  return (
    ...
    >
      ...
      <rect x="10" y="10" width="230" height="280" rx="12" fill="var(--color-cool-sky-light)" />
      
      {/* Farm background - golden hour field */}
      <defs>
        <linearGradient id="sunsetSky" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="var(--color-cool-sky-light)" />
      ...
      <g stroke="#ca8a04" strokeWidth="1.5">
        <line x1="30" y1="200" x2="30" y2="175" /><circle cx="30" cy="172" r="3" fill="var(--color-cool-sky)" />
        <line x1="45" y1="200" x2="45" y2="170" /><circle cx="45" cy="167" r="3" fill="var(--color-cool-sky)" />
        <line x1="60" y1="200" x2="60" y2="178" /><circle cx="60" cy="175" r="3" fill="var(--color-cool-sky)" />
        <line x1="75" y1="200" x2="75" y2="168" /><circle cx="75" cy="165" r="3" fill="var(--color-cool-sky)" />
        <line x1="90" y1="200" x2="90" y2="173" /><circle cx="90" cy="170" r="3" fill="var(--color-cool-sky)" />
      </g>
      ...
      <g transform="translate(50, 70)">
        ...
        {/* CAT logo on front */}
        <rect x="42" y="12" width="36" height="14" rx="2" fill="var(--color-imperial-blue)" />
        ...
        {/* Eyes - kind, squinting */}
        <path d="M42 55 Q47 51, 52 55" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        <path d="M68 55 Q73 51, 78 55" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        ...
        {/* Warm smile */}
        <path d="M48 75 Q60 85, 72 75" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        ...
        {/* Flannel shirt */}
        <rect x="35" y="108" width="50" height="22" fill="var(--color-hot-rose)" />
        <g stroke="var(--color-hot-rose-hover)" strokeWidth="1">
        ...
        {/* OVERALLS */}
        <rect x="28" y="128" width="64" height="85" rx="4" fill="var(--color-cool-sky)" />
        {/* Overall bib */}
        <rect x="42" y="115" width="36" height="18" rx="2" fill="var(--color-cool-sky)" stroke="var(--color-cool-sky-hover)" strokeWidth="1" />
        {/* Straps - connected to body */}
        <path d="M45 115 L40 105 Q48 100, 55 105 L50 115" fill="var(--color-cool-sky)" stroke="var(--color-cool-sky-hover)" strokeWidth="1" />
        <path d="M70 115 L65 105 Q72 100, 80 105 L75 115" fill="var(--color-cool-sky)" stroke="var(--color-cool-sky-hover)" strokeWidth="1" />
        {/* Brass buttons */}
      ...
      <text x="190" y="52" textAnchor="middle" fontSize="9" fill="var(--color-imperial-blue)">It ain't much</text>
      <text x="190" y="65" textAnchor="middle" fontSize="9" fill="var(--color-imperial-blue)">but it's</text>
      <text x="190" y="80" textAnchor="middle" fontSize="10" fontWeight="700" fill="var(--color-stormy-teal-hover)">honest work</text>
      ...
      <text x="125" y="284" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--color-stormy-teal-hover)">= Honest growth</text>
      ...
      <rect x="295" y="10" width="215" height="280" rx="12" fill="var(--color-imperial-blue)" />
      ...
      <g transform="translate(320, 70)">
        ...
        <rect x="92" y="60" width="4" height="8" fill="#ca8a04" stroke="var(--color-imperial-blue)" strokeWidth="0.5" />
        <rect x="98" y="59" width="4" height="9" fill="var(--color-cool-sky)" stroke="var(--color-imperial-blue)" strokeWidth="0.5" />
        <rect x="104" y="60" width="4" height="7" fill="#ca8a04" stroke="var(--color-imperial-blue)" strokeWidth="0.5" />
        <rect x="110" y="61" width="4" height="6" fill="#fef9c3" stroke="var(--color-imperial-blue)" strokeWidth="0.5" />
        
        {/* TRENCH COAT */}
        <path d="M40 85 L25 175 L115 175 L100 85 Z" fill="#1c1917" />
        {/* Popped collar */}
        <path d="M45 85 Q58 70, 68 85" fill="#1c1917" stroke="var(--color-imperial-blue)" strokeWidth="1" />
        <path d="M72 85 Q82 70, 95 85" fill="#1c1917" stroke="var(--color-imperial-blue)" strokeWidth="1" />
        ...
        <g transform="translate(-30, 130)">
          <rect x="0" y="0" width="32" height="22" rx="3" fill="var(--color-hot-rose)" />
      ...
      <path d="M430 45 Q435 25, 500 25 L500 85 L455 85 L445 100 L450 85 L430 85 Z" fill="var(--color-imperial-blue)" stroke="#475569" strokeWidth="2" />
      ...
      <text x="400" y="284" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--color-hot-rose)">= Sketchy waste</text>
    </svg>
  );
}
...
function DetectiveBoard() {
  return (
    ...
    >
      ...
      <rect x="5" y="5" width="410" height="250" rx="6" fill="var(--color-imperial-blue)" />
      ...
      <rect x="130" y="25" width="160" height="35" rx="3" fill="var(--color-cool-sky-light)" transform="rotate(-2 210 40)" stroke="var(--color-imperial-blue)" strokeWidth="1" />
      <text x="210" y="48" textAnchor="middle" fontSize="18" fontWeight="700" fill="var(--color-imperial-blue)">CASE FILE</text>
      {/* Red push pins */}
      <circle cx="140" cy="30" r="6" fill="var(--color-hot-rose)" stroke="var(--color-hot-rose-hover)" strokeWidth="1" />
      <circle cx="280" cy="32" r="6" fill="var(--color-hot-rose)" stroke="var(--color-hot-rose-hover)" strokeWidth="1" />
      ...
      <g transform="translate(28, 70)">
        ...
        {/* Face */}
        <circle cx="55" cy="42" r="22" fill="var(--color-cool-sky-light)" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        {/* Panicked X eyes */}
        <path d="M45 38 L50 43 M45 43 L50 38" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        <path d="M60 38 L65 43 M60 43 L65 38" stroke="var(--color-imperial-blue)" strokeWidth="2" />
        {/* Worried wavy mouth */}
        <path d="M45 55 Q50 50, 55 55 Q60 60, 65 55" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        {/* Multiple sweat drops */}
        <path d="M78 30 Q80 25, 82 30 Q80 33, 78 30" fill="var(--color-cool-sky)" />
        <path d="M82 42 Q84 38, 86 42 Q84 45, 82 42" fill="var(--color-cool-sky)" />
        <path d="M30 35 Q28 31, 26 35 Q28 38, 30 35" fill="var(--color-cool-sky)" />
        
        {/* Name plate */}
        <rect x="10" y="85" width="90" height="45" fill="white" />
        <text x="55" y="102" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">UNPREPARED</text>
        <text x="55" y="116" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">PETE</text>
        <text x="55" y="130" textAnchor="middle" fontSize="9" fill="#64748b">Crime: Bad CTR</text>
      </g>
      {/* Push pin */}
      <circle cx="85" cy="75" r="5" fill="var(--color-hot-rose)" />
      ...
      <g transform="translate(155, 68)">
        ...
        <path d="M42 38 Q47 34, 52 38" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        <path d="M58 38 Q63 34, 68 38" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        {/* Sneaky grin */}
        <path d="M42 52 Q55 62, 68 52" stroke="var(--color-imperial-blue)" strokeWidth="2" fill="none" />
        ...
        {/* Name plate */}
        <rect x="10" y="85" width="90" height="45" fill="white" />
        <text x="55" y="102" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">SPAMMY</text>
        <text x="55" y="116" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">SAM</text>
        <text x="55" y="130" textAnchor="middle" fontSize="9" fill="#64748b">Crime: Link dump</text>
      </g>
      {/* Push pin */}
      <circle cx="210" cy="72" r="5" fill="var(--color-hot-rose)" />
      ...
      <g transform="translate(282, 70)">
        ...
        <line x1="42" y1="38" x2="52" y2="38" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        <line x1="58" y1="38" x2="68" y2="38" stroke="var(--color-imperial-blue)" strokeWidth="3" />
        {/* Bags under eyes */}
        ...
        {/* Yawning/lazy mouth */}
        <ellipse cx="55" cy="54" rx="6" ry="4" fill="var(--color-imperial-blue)" />
        {/* Zzz floating */}
        ...
        {/* Name plate */}
        <rect x="10" y="85" width="90" height="45" fill="white" />
        <text x="55" y="102" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">INCONSISTENT</text>
        <text x="55" y="116" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--color-hot-rose-hover)">IAN</text>
        <text x="55" y="130" textAnchor="middle" fontSize="9" fill="#64748b">Crime: Ghosting</text>
      </g>
      {/* Push pin */}
      <circle cx="338" cy="75" r="5" fill="var(--color-hot-rose)" />

      {/* Red string connecting them - detective style */}
      <path d="M135 120 Q175 100, 165 125" stroke="var(--color-hot-rose)" strokeWidth="2" fill="none" />
      <path d="M260 118 Q280 105, 290 122" stroke="var(--color-hot-rose)" strokeWidth="2" fill="none" />
      {/* Extra string going up to case file */}
      <path d="M210 70 Q210 55, 210 50" stroke="var(--color-hot-rose)" strokeWidth="1.5" fill="none" />

      {/* "WANTED" stamp - big and dramatic */}
      <g transform="translate(300, 215) rotate(-8)">
        <rect x="0" y="0" width="90" height="28" rx="3" fill="none" stroke="var(--color-hot-rose)" strokeWidth="3" />
        <text x="45" y="20" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--color-hot-rose)">WANTED</text>
      </g>

      {/* Additional detective notes */}
      <rect x="25" y="218" width="100" height="25" rx="2" fill="#fef9c3" transform="rotate(-3 75 230)" />
      <text x="75" y="233" textAnchor="middle" fontSize="8" fill="var(--color-imperial-blue)">Check all suspects!</text>
      {/* Push pin for note */}
      <circle cx="30" cy="220" r="4" fill="var(--color-cool-sky)" />
    </svg>
  );
}
...
function ChannelCard({ icon, title, leverage, description }: ChannelCardProps) {
  const leverageColors = {
    high: { bg: "#dcfce7", text: "var(--color-stormy-teal-hover)" },
    medium: { bg: "var(--color-cool-sky-light)", text: "var(--color-imperial-blue)" },
...
function CaseCard({ issue, description, fix }: CaseCardProps) {
  return (
    ...
    >
      ...
      >
        <strong style={{ color: "var(--color-stormy-teal-hover)" }}>Fix:</strong> {fix}
      </div>
    </div>
  );
}
...
function CheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-stormy-teal)" strokeWidth="2" aria-hidden="true" focusable="false">
...
function YouTubeIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-hot-rose)" strokeWidth="2" aria-hidden="true" focusable="false">
      <rect x="2" y="3" width="20" height="18" rx="3" />
      <path d="M10 8l6 4-6 4V8z" fill="var(--color-hot-rose)" stroke="none" />
    </svg>
  );
}
...
function SocialIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-cool-sky)" strokeWidth="2" aria-hidden="true" focusable="false">
