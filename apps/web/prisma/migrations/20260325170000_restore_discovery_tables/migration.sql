-- Restore discovery tables dropped in 20260304162348_add_perf_cache_models.
-- These are worker-managed tables used by the Trending page (/api/competitors/discover).
-- Using IF NOT EXISTS so this is safe to run on databases that already have them.
